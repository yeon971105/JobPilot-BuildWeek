...
export function ProfileMenu() {
  ...
  return <details className="relative">
    ...
    <div className="absolute right-0 z-50 mt-2 grid min-w-64 gap-1 rounded-2xl border border-[#173d2d]/10 bg-[#fffdf7] p-2 shadow-[0_18px_45px_rgba(39,61,49,.18)]">
      <Link href="/profile" className="rounded-xl px-4 py-3 text-sm font-semibold hover:bg-[#edf1e8]">View Demo Profile</Link>
      <Link href="/profile/resume" className="rounded-xl px-4 py-3 text-sm font-semibold hover:bg-[#edf1e8]">Use My Resume Privately</Link>
      <Link href="/profile/preferences" className="rounded-xl px-4 py-3 text-sm font-semibold hover:bg-[#edf1e8]">Work Preferences</Link>
