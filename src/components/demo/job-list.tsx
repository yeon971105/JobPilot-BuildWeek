...
import { ArrowUpRight, Bookmark, Filter, MapPin, Search, SlidersHorizontal, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fbf7ed] pb-28 text-[#173d2d]">
      ...
      <main className="mx-auto max-w-7xl px-5 py-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-5">
          ...
          <Link href="/demo/compare" className="button-secondary">Compare Selected ({tracker.comparisonIds.length}/3)</Link>
        </div>
